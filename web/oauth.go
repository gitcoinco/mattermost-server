...
func authorizeOAuthPage(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	//w.Header().Set("X-Frame-Options", "SAMEORIGIN") // TODO: sort this out
	w.Header().Set("Content-Security-Policy", "frame-ancestors 'self' https://gitcoin.co https://www.gitcoin.co")
